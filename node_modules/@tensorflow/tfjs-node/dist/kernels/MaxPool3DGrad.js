...
exports.maxPool3DGradConfig = {
    ...
    kernelFunc: function (args) {
        ...
        var _b = args.attrs, filterSize = _b.filterSize, strides = _b.strides, pad = _b.pad, dilations = _b.dilations, dimRoundingMode = _b.dimRoundingMode;
        var convInfo = tfjs_1.backend_util.computePool3DInfo(input.shape, filterSize, strides, dilations, pad, dimRoundingMode);
