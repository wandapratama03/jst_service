...
exports.avgPool3DConfig = {
    ...
    kernelFunc: function (args) {
        ...
        var _a = args.attrs, filterSize = _a.filterSize, strides = _a.strides, pad = _a.pad, dimRoundingMode = _a.dimRoundingMode, dataFormat = _a.dataFormat, dilations = _a.dilations;
        var convInfo = tfjs_1.backend_util.computePool3DInfo(x.shape, filterSize, strides, dilations, pad, dimRoundingMode, dataFormat);
